...
#    level_difficulty: "Difficulty: "
  ...
  contact:
    ...
    contribute_prefix: "اگر به همکاری با ما علاقه مند هستید اینجا را چک کنید"
...
#    forum_suffix: " instead."
  ...
  diplomat_suggestion:
    title: "CodeCombat کمک به ترجمه"
    sub_heading: ".ما به مهارت شما در زبان نیاز داری"
...
#    customize_avatar: "شخصی سازی آواتار"

#  account_settings:
    title: "تنظیمات حساب کاربری"
    not_logged_in: ".برای تغییر در تنظیمات خود وارد شوید یا حساب کاربری ایجاد کنید"
    autosave: "ثبت تغییرات به صورت خودکار"
#    me_tab: "من"
    picture_tab: "تصویر"
#    wizard_tab: "جادوگر"
    password_tab: "رمز عبور"
    emails_tab: "ایمیل ها"
...
#    profile_for_suffix: ""
#    profile: "Profile"
#    user_not_found: "کاربری پیدا نشد.آدرس بررسی شود؟"
